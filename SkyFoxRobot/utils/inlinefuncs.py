...
from SkyFoxRobot import pbot as app
from SkyFoxRobot import arq
from SkyFoxRobot.services.keyboard import Ikb
from SkyFoxRobot.utils.pluginhelper import (
    convert_seconds_to_minutes as time_convert,
    fetch,
)
from SkyFoxRobot.services.tasks import _get_tasks_text, all_tasks, rm_task
from SkyFoxRobot.services.types import InlineQueryResultCachedDocument
from SkyFoxRobot.modules.info import get_chat_info, get_user_info
from SkyFoxRobot.modules.music import download_youtube_audio
from SkyFoxRobot.utils.functions import test_speedtest
from SkyFoxRobot.utils.pastebin import paste
...
async def alive_function(answers):
    ...
    msg = f"""
**[SkyFox Robot ❤️](https://t.me/SkyFoxybot):**
**MainBot:** `{bot_state}`
**UserBot:** `{ubot_state}`
...
**Profiles:** [BOT](t.me/{BOT_USERNAME}) | [UBOT](t.me/laz1yy)
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
            description="Check Bot's Stats",
            thumb_url="https://telegra.ph/file/281fbf2e19c36b34d4f40.jpg",
            input_message_content=InputTextMessageContent(
