...
from SkyFoxRobot.__main__ import STATS, TOKEN, USER_INFO
from SkyFoxRobot.modules.sql import SESSION
import SkyFoxRobot.modules.sql.userinfo_sql as sql
from SkyFoxRobot.modules.disable import DisableAbleCommandHandler
from SkyFoxRobot.modules.sql.global_bans_sql import is_user_gbanned
from SkyFoxRobot.modules.sql.afk_sql import is_afk, set_afk
from SkyFoxRobot.modules.sql.users_sql import get_user_num_chats
from SkyFoxRobot.modules.helper_funcs.chat_status import sudo_plus
from SkyFoxRobot.modules.helper_funcs.extraction import extract_user
...
def info(update: Update, context: CallbackContext):
    ...
    if user.id == OWNER_ID:
        ...
        text += "\n\nOwner Of A Bot. Queen Of @laz1yy. Bot Name Inspired From 'JoJo'."
        disaster_level_present = True
            ...
            message.reply_document(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "Health", url="https://t.me/arkabotupdate"
                            ),
                            InlineKeyboardButton(
                                "Disaster", url="https://t.me/arkabotupdate"
                            ),
                        ],
                    ]
                ),
...
def stats(update: Update, context: CallbackContext):
    stats = (
        "❂ <b>Stats For <a href='https://t.me/SkyFoxybot'>SkyFox Robot</a>:</b>\n"
