...
import sys
import traceback
import SkyFoxRobot.modules.sql.users_sql as sql
from sys import argv
from typing import Optional
from telegram import __version__ as peler
from platform import python_version as memek
from SkyFoxRobot import (
    ALLOW_EXCL,
    CERT_PATH,
    DONATION_LINK,
    LOGGER,
...
from SkyFoxRobot.modules import ALL_MODULES
from SkyFoxRobot.modules.helper_funcs.chat_status import is_user_admin
from SkyFoxRobot.modules.helper_funcs.misc import paginate_modules
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("SkyFoxRobot.modules." + module_name)
...
def SkyFox_about_callback(update, context):
    query = update.callback_query
    if query.data == "SkyFox_":
        query.message.edit_text(
            text="๏ I'm *SkyFox*, a powerful group management bot built to help you manage your group easily."
            ...
            "\n\n_SkyFox's licensed under the GNU General Public License v3.0_"
            "\n\n Click on button bellow to get basic help for SkyFoxRobot.",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
...
**Telegram Library:** `v{peler}`""",
    ...
    about_callback_handler = CallbackQueryHandler(
        SkyFox_about_callback, pattern=r"SkyFox_", run_async=True
    )
